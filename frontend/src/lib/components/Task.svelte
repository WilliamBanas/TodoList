...
<li
	role="listitem"
	id={task.id}
	class="w-full bg-background text-foreground border border-secondary/50 hover:ring-1 hover:ring-primary relative flex min-h-20 flex-col justify-start rounded px-3 py-2"
	draggable="true"
	on:drag
